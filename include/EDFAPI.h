...
namespace EDF::API {
    ...
    public:
        ...
        virtual bool QueueCreateRule(const CreateRuleRequest*, Callback, void*) noexcept = 0;
        virtual bool QueueUpdateRule(const UpdateRuleRequest*, Callback, void*) noexcept = 0;
        virtual bool QueueDeleteRule(const DeleteRuleRequest*, Callback, void*) noexcept = 0;
        virtual bool QueueLookupRule(const LookupRuleRequest*, Callback, void*) noexcept = 0;
        virtual bool QueueReevaluateActor(const ActorRequest*, Callback, void*) noexcept = 0;
        virtual bool QueueResetActor(const ActorRequest*, Callback, void*) noexcept = 0;
    };
    ...
    inline IEDFRuleAPI* GetAPI() noexcept {
        ...
        using Getter = void* (*)();
        const auto getter = reinterpret_cast<Getter>(GetProcAddress(module, "GetEDFRuleAPI"));
